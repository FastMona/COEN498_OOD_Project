...
%
%   visualize_ood_examples() runs MD_Stage1_Prefilter on KMNIST_japanese with vigilance
...
%   from each group.
	...
	results = MD_Stage1_Prefilter(oodFolder, vigilance, false, false);
	...
	title(t, sprintf('MD\_Stage1\_Prefilter at vigilance %.2f', vigilance));
